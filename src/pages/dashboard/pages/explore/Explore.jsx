...
const Explore = () => {
  ...
  return (
    <section className="backdrop-blur-sm duration-700 pt-[5rem] grid grid-cols-1 place-items-center space-y-5">
      <section>
        <input
          type="search"
          name="searchData"
      ...
      {songs.map((song) => {
        return (
          <Fragment key={song._id}>
            <section className="h-[100px] w-[80%] bg-white/5 backdrop-blur-lg border bg-cover rounded-lg p-2"
