...
const Explore = () => {
  ...
  return (
    <>
      ...
      md:pt-[9rem] lg:pt-[12rem] p-2 md:p-4 lg:p-6  text-sm md:text-base lg:text-lg flex flex-col items-center justify-center"
      >
        <input
          type="search"
          name="searchData"
          ...
          autoFocus
        />
        <section className="p-2 md:p-4 lg:p-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 place-items-center gap-5">
        {songs.map((song) => {
          return (
            <Fragment key={song._id}>
              <section
                className="h-[70px] md:h-[80px] lg:h-[90px] w-[80%] bg-white/5 backdrop-blur-lg border bg-cover rounded-lg p-2 md:p-4 lg:p-6"
